...
A lightweight browser native way to change color themes.
`ThemeIT!` leverages the awesome power of `CSS` variables and `HTML` link element and glues those two together with `Javascript` to allow theme customization inside of your web app, react app or website.
